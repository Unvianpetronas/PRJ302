 ...
 * @author tuanm
 */
@WebServlet(name = "UpdateFromCartController", urlPatterns = {"/UpdateFromCartController"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (quantity > 0) {
                ...
                boolean check = cart.update(id, quantity);
                if (check) {
                ...
                request.setAttribute("MESS", "Quantity must more than 0!.");
            }
        } catch (Exception e) {
